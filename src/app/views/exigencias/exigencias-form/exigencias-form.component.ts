...
@Component({
  ...
  templateUrl: './exigencias-form.component.html',
  styleUrl: './exigencias-form.component.scss'
})
export class exigenciasFormComponent implements OnChanges {
  form!: FormGroup;
  submitted = false;
  errors: any;
